...
class _RegisterVaccCentreState extends State<RegisterVaccCentre> {
  void uploadData() {
    FirebaseFirestore.instance //add new doc to the data store
        // .collection("vaccncents")
        .collection("covamsdata")
        .doc(uniqueIdController.text)
        .set({
      "Account Type": "Hospital/Vaccination Centre",
  ...
  _successAlert(context) {
    Alert(
      context: context,
      title: "SUCCESS",
      desc: "Vaccination centre sucessfully registered",
    ).show();
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            padding:
                EdgeInsets.symmetric(vertical: 3, horizontal: size.width / 100),
          ...
          SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: "Give Vaccination Center a unique ID",
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(8.0),
                ),
                focusedBorder: const OutlineInputBorder(
