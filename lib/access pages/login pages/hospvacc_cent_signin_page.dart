...
class HospVaccCentSignInPage extends StatefulWidget {
  ...
  @override
  _HospVaccCentSignInPageState createState() => _HospVaccCentSignInPageState();
}

class _HospVaccCentSignInPageState extends State<HospVaccCentSignInPage> {
...
class HospVaccCentreSignIn extends StatefulWidget {
  ...
  @override
  State<HospVaccCentreSignIn> createState() => _HospVaccCentreSignInState();
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Spacer2(),
          Text(
            "Sign In as a Hospital/Vaccination Centre",
            style: TextStyle(
              fontFamily: 'Poppins',
              // color: Colors.black,
